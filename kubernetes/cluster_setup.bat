...
minikube addons enable registry -p knative
if errorlevel 1 (
    echo Failed to enable registry addon.
    exit /b 1
)

minikube addons enable registry-aliases -p knative
if errorlevel 1 (
    echo Failed to enable registry-aliases addon.
    exit /b 1
)
